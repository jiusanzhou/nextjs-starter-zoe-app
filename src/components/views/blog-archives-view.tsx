/**
 * Shared blog archives renderer (locale-aware).
 *
 * Default route `(site)/blog/archives` passes the default locale.
 * Non-default routes `[lang]/blog/archives` pass `lang`.
 */
...
interface BlogArchivesViewProps {
  locale?: string;
}
...
export function BlogArchivesView({ locale }: BlogArchivesViewProps = {}) {
