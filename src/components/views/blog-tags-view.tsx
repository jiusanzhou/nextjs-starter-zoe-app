/**
 * Shared blog tags index renderer (locale-aware).
 *
 * Default route `(site)/blog/tags` passes the default locale.
 * Non-default routes `[lang]/blog/tags` pass `lang`.
 */
...
export function BlogTagsView({ locale }: BlogTagsViewProps = {}) {
