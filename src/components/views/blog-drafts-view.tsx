/**
 * Shared blog drafts renderer (locale-aware).
 *
 * Drafts are visible in dev only (and SSR pages where they're statically
 * generated but should not appear in the published feed).
 */
...
interface BlogDraftsViewProps {
  locale?: string;
}

export function BlogDraftsView({ locale }: BlogDraftsViewProps = {}) {
    ...
    <div className="page-drafts max-w-3xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 py-4">
        ...
        <Button variant="outline" size="sm" asChild className="self-start">
          <Link href={`${prefix}/blog`} className="flex items-center gap-1.5">
